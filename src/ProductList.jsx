...
function ProductList({ onHomeClick }) {
  ...
  const totalQty = cartItems?.reduce((acc, it) => acc + it.quantity, 0) || 0;
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: "Tolerates neglect and adapts well.",
          cost: "$10",
        },
        {
          name: "Snake Plant",
        ...
        <div style={styleObjUl}>
          ...
          <div style={{ position: "relative" }}>
            <a href="#" onClick={handleCartClick} style={styleA}>
              <span role="img" aria-label="Open cart" style={{ fontSize: 34 }}>
                🛒
              </span>
            </a>
            <span
              ...
              aria-label={`Total items in cart: ${totalQty}`}
            >
              {totalQty}
            </span>
          </div>
